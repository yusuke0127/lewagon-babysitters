...
ActiveRecord::Schema.define(version: 2020_05_19_093417) do
  ...
  create_table "reservations", force: :cascade do |t|
    ...
    t.index ["babysitter_id"], name: "index_reservations_on_babysitter_id"
  ...
  add_foreign_key "reservations", "babysitters"
